...
class MJ_Blog_Templates_Exclude_Post_Type {
	...
	function network_admin_page() {
		$this->exclude_cpt_settings_check = add_submenu_page( 'settings.php', __( 'Exclude CPT', $this->localization_domain ), __( 'Exclude CPT', $this->localization_domain ), 'administrator', basename( __FILE__ ), array(
				&$this,
				'admin_options_page'
			) );
	}
